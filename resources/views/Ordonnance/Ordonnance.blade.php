...
<div class="container-fluid mb-5 ">
  ...
  <div class="container-fluid mt-5 mb-5">
    ...
    <div class="row border border-dark ">
      <div  class="col-sm bg-white float-start  p-4 ps-5 pe-0" style=" color:white;"><h3>Docteur {{ $Ordonnance->nom_med }}</h3><br />
                            <h3 class="fs-6 text-black-50">Medecin general</h3>
                            <h3 class="fs-6 text-black-50 ">Diplomé de la faculté de medcine à Fes</h3>                          
                            <h3 class="fs-6 text-black-50">Mr/Mm {{$Ordonnance->nom_pat}} {{$Ordonnance->prenom_pat}}</h3>  
                           </div>
      <div  class="col-sm bg-white float-end fs-6 p-5 pe-5 ps-0">
                            ...
                            <p name="" id="" cols="200" rows="10">Mm/Mr {{$Ordonnance->nom_pat}}  {{$Ordonnance->prenom_pat}}</p><br><br><br>
                            <p name="" id="" cols="200" rows="10">{{$Ordonnance->description}}</p><br><br><br><br><br>
