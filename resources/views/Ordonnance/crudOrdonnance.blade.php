    ...
    <table cellpadding="0" cellspacing="1" border="0">
      <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <button type="button" class="btn btn-success" id="load1" style="color:white" ><a href="{{route('Ordonnance.Modify',$Ordonnance->id)}}" class="btn btn-success ps-0 py-0 pe-0">edit</a></button>
                    <button type="button" class="btn btn-warning" id="load1" style="color:white"  ><a href="{{route('Ordonnance.Voir',$Ordonnance->id)}}"  class="btn btn-warning ps-0 py-0 pe-0">see</a></button>
                    <button type="button" class="btn btn-danger" id="load1" style="color:white"  ><a href="{{route('Ordonnance.delete',$Ordonnance->id)}}" class="btn btn-danger ps-0 py-0 pe-0">delete</a></button>
                    </td>
                </tr>
                @endforeach
...
<button type="button" class="btn btn-primary btn-lg " id="load1"  data-loading-text=" Processing Order"><i class='fa fa-circle-o-notch fa-spin'></i><a href="{{route('Ordonnance.create')}} " style="color:white" class="btn btn-sm me-2">Ajouter une Ordonnance</a>
</button>
