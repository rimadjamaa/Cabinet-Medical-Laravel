...
<section>
  <!--for demo wrap-->
  <h1>Gestion des Fiches Patients</h1>
...
<button type="button" class="btn btn-primary btn-lg " id="load1"  data-loading-text=" Processing Order"><i class='fa fa-circle-o-notch fa-spin'></i><a href="{{ url('/Fiche_Patient/create') }}" style="color:white" class="btn btn-sm me-2">Ajouter une Fiche</a>
</button>
</div>
